...
?>
<?php echo form_open('verify_operator/slot_edit/'.$row->id,array('class'=>'ajax'));?>
    <table class="table table-condensed info">
        ...
        <tr><td><label>Amount</label><?php echo form_error('amnt','<div class="error">','</div>');?><input type="text" name="amnt" class="form-control pull-right" value="<?php echo $row->amount;?>"></td></tr>
        ...
        <tr><td><input type="submit" class="btn btn-success btn-sm pull-right" value="update" name="save"></td></tr>
        </table>
        <?php echo form_close();?>
<?php
}
